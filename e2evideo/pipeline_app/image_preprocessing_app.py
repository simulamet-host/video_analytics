...
class ImagePreprocessing:
    ...
    def run(self):
        ...
        self.images_path = video_preprocessing.folder_selector_ui(self.starting_path, button_id=1)
        self.output_folder = os.path.join(self.starting_path , ".npz")
        self.cmd_list = ['python', '../image_preprocessing.py', '--dir' , self.images_path,
        ...
        self.cmd_list.extend(['--resize', str(self.resize), '--img_width', str(self.img_width),
